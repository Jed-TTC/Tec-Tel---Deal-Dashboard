...
type Variant = 'high' | 'medium' | 'low' | 'fellow' | 'outlook' | 'hubspot' | 'ai' | 'email' | 'meeting' | 'pending' | 'approved' | 'rejected';
...
const styles: Record<Variant, string> = {
  ...
  hubspot: 'bg-orange-100 text-orange-700 border border-orange-200',
